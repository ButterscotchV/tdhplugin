...
namespace TDHPlugin
{
	...
	public class TDHPlugin : Plugin
	{
		...
		// Registers lang setting CONFIG_VALUE in TDHPlugin with a default of "Config value: " on initialization
		[LangOption] 
		...
		public bool GiveLottoItem(Player player)
		{
			...
			if (!player.HasPermission("TDHPlugin.lottoitem"))
			{
				return false;
			}
